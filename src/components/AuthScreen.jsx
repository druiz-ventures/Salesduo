...
const styles = {
  ...
  title: { color: "#f1f5f9", fontSize: "30px", fontWeight: "800", margin: "0 0 4px" },
  subtitle: { color: "#94a3b8", fontSize: "14px", margin: "0 0 24px" },
  tabs: {
    display: "flex",
    background: "#0f172a",
    borderRadius: "10px",
  ...
  dividerText: { color: "#475569", fontSize: "12px", whiteSpace: "nowrap" },
  ...
  successMsg: { color: "#34d399", fontSize: "13px", margin: "12px 0 0" },
  legal: { color: "#475569", fontSize: "11px", marginTop: "20px" },
};
