  ...
  return (
    <div style={s.overlay}>
      <div style={s.card}>
        ...
        {/* Pregunta 6 */}
        <div style={s.question}>
          <p style={s.questionText}>¿Qué mejorarías? <span style={{ color: "#475569" }}>(opcional)</span></p>
          <textarea
            style={s.textarea}
...
const s = {
  ...
  title: { color: "#f1f5f9", fontSize: "20px", fontWeight: "800", margin: "0 0 6px" },
  sub:   { color: "#64748b", fontSize: "13px", margin: "0 0 24px" },
  question: { marginBottom: "22px" },
  questionText: { color: "#cbd5e1", fontSize: "14px", fontWeight: "600", margin: "0 0 10px" },
  ...
  npsHint: { color: "#475569", fontSize: "11px", margin: "8px 0 0" },
  textarea: {
    width: "100%",
    padding: "12px 14px",
    borderRadius: "10px",
